  ...
  return (
    <div className="page-content-wrapper ">
      ...
      <div className="content sm-gutter">
        <div data-pages="parallax m-t-50" style={{ background: "white" }}>
          <div className=" container no-padding    container-fixed-lg">
            <div
              className="inner"
              style={{ transform: "translateY(0px)", opacity: 1 }}
            >
              <ol className="breadcrumb p-l-10 p-t-5 p-b-5 breadcrumb-alt">
        ...
        <div className="container no-padding sm-padding-10 p-t-20">
          <div className="row">
